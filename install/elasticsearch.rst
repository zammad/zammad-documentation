...
Build/rebuild the searchindex
   .. hint::
      - The rebuild of the search index may take a while, if you run it for
        already productive systems with a lot of data.
      ...
      - The rebuild may take many hours or even days, if a lot of data is
        present. However, you can safely run this during operating times without
        the risk of loosing data. As a downside, it could lead to reduced
        performance and that some data may not be shown in search results.
