...
This is an application level issue and is subject to change - you can find more information about this in `Issue 2651 <https://github.com/zammad/zammad/issues/2651>`_.
To solve this, just go into the Univention App-Settings (for Zammad-App) and apply the settings **after** finishing the wizard.


Customers can't click on the "Knowledgebase"-URL within the customer portal
---------------------------------------------------------------------------

This currently can't be fixed, as Zammad is available via one Port only.
The issue is described within `Issue 2628 <https://github.com/zammad/zammad/issues/2628>`_ and is subject to fix.
